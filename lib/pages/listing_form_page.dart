  ...
  Future<void> saveLocal(bool partial) async {
    ...
    try {
      ...
      final data = {
        ...
        'division_code': selectedGeo?['division_code'],
        'district_code': selectedGeo?['district_code'],
        'ctc': selectedGeo?['ctc'],
        'upazila_code': selectedGeo?['upazila_code'],
        'psc': selectedGeo?['psc'],
        'union_code': selectedGeo?['union_code'],
        'mouza_code': selectedGeo?['mouza_code'],
        'village_code': selectedGeo?['village_code'],
        'rmo_tus': selectedGeo?['rmo_tus'],
        'rmo_phc': selectedGeo?['rmo_phc'],
